...
# Esta funcion carga los documentos de las URLs y PDF's, los vuelve chunks, los transforma en vectores (valor semántico) y los indexa en una tienda de vectores (FAISS)
...
# Herramientas para el agente, retriever y Tavily
...
def create_agent():
    ...
    agent_prompt = ChatPromptTemplate.from_messages(
        [
            ...
            (
                "system",
                "Your answers must be long, clear and detailed.",
            ),
            (
                "system",
                "You must only answer questions that are directly related to Promtior.",
            ),
            (
                "system",
